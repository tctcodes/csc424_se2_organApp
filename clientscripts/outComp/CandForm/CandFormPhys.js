...
const withReducer = injectReducer({ key: 'CandFormPhys', reducer });
const withSaga = injectSaga({ key: 'CandFormPhys', saga });
export default compose( withReducer, withSaga, withConnect)(CandFormPhys);
