CREATE TABLE DONOR_DISPOSITION (
	...
	DON_DCD_RECOV_DT                       NUMERIC(8),	-- MMDDYY      -- If DCD, Date organ recovered/removed from donor
	DON_DCD_RECOV_TM                       NUMERIC(8),	-- TIME        -- If DCD, Time organ recovered/removed from donor
	...
	DON_VESSEL_SENT                        NUMERIC(3),	               -- OPO sent vessels with organ
